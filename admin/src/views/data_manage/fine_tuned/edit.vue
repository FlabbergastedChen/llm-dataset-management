...
import { finetunedAdd, finetunedEdit, finetunedDetail } from '@/api/finetuned'
...
const handleSubmit = async () => {
    ...
    mode.value == 'edit' ? await finetunedEdit(data) : await finetunedAdd(data)
...
const getDetail = async (row: Record<string, any>) => {
    const data = await finetunedDetail({
        id: row.id
    })
    setFormData(data)
}
