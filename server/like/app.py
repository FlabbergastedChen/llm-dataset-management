...
def configure_admin_router(app: FastAPI, prefix='/api'):
    ...
    from .config import get_settings
    from .admin.routers import user, common, system, monitor, setting, channel, article, decorate, dataset,finetuned
    ...
    app.include_router(dataset.router,prefix = prefix,dependencies=admin_deps)
    app.include_router(finetuned.router,prefix=prefix,dependencies=admin_deps)
    # gen
